...
I am a Ph.D. from <strong>ZheJiang University</strong>, with the <strong>State Key Laboratory</strong> of Industrial Control Technology. My research interests lie in the areas of <strong>Advanced Robust Motion Control</strong>, including but not limited to <strong>ground vehicles</strong>, <strong>UAVs</strong> (experiments over 8+ years) and brushless DC motors. 
 
I have a strong track record in creating complex mechanical, circuit systems from scratch (see my <a href="./markdown" target="_blank" rel="noopener">Projects</a>). I am a <strong>master in Matlab/Simulink</strong> and rapid control algorithm implementation to real industrial systems is within my capabilities.
        ...
        <div class="card-body">
          <div class="d-flex align-content-start">
            ...
            <div>
              ...
              <div class="section-subheading card-title exp-title text-muted my-0">Postdoctoral Research Fellow with ZheJiang University & Senior Software Engineer </div>
...
<p>
    ...
    <a class="btn btn-outline-primary btn-page-header btn-sm" href="https://ieeexplore.ieee.org/document/10517629" target="_blank" rel="noopener"> PDF </a>
...
<ul class="ul-interests mb-0">
    ...
    <p>
      <a class="btn btn-outline-primary btn-page-header btn-sm" href="../files/patent_vector.pdf" target="_blank" rel="noopener">PDF </a>
...
<div class="paper-box-text">
    ...
    <p> <a href="./markdown"  target="_blank" rel="noopener">Adaptive Multivariable Super-Twisting Control for Nonlinear Systems and Its Application to A Novel Fully Actuated UAV</a> <br>
...
<div class="paper-box"><div class="paper-box-image"><div><div class="badge">Transactions on Circuits and Systems II</div><img src="../images/motor.png" alt="sym" width="100%"></div></div>
<div class="paper-box-text">

    <p> <a href="./markdown"  target="_blank" rel="noopener">Adaptive Quasi-Fixed-Time Integral Terminal Sliding Mode Control for Nonlinear Systems</a> <br>
    <strong>Zhangzhen Zhu</strong>, Yongliang Lin, Yu Zhang</p>
